  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-fill lg:py-0 gap-3">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="handel_login.php"  method="post">
                  <div>
...
<section style="display:none;" class="bg-gray-50 dark:bg-gray-900" id="register">
    ...
    <div class="max-w-md mx-auto  rounded-md overflow-hidden shadow-md bg-gray-800 ">
        ...
        <form class="px-6 py-4" action="handel_register.php" method="post" enctype="multipart/form-data">
            <!-- Name Input -->
            <div class="mb-4">
