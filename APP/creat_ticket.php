    ...
    <form action="handel_creat_ticket.php" method="post">
        ...
        <div class="mb-4">
            ...
            <select id="user" name="user" class="w-full px-3 py-2 border rounded-md text-gray-400 bg-gray-700">
                ...
                <option name="assign" value="user1">User 1</option>
                <option name="assign" value="user2">User 2</option>
                <option name="assign" value="user3">User 3</option>
            </select>
        </div>
        ...
        <div class="mb-4">
            ...
            <select id="tag" name="user" class="w-full px-3 py-2 border rounded-md text-gray-400 bg-gray-700">
                ...
                <option name="tag" value="bug">bug</option>
                <option name="tag" value="question">question</option>
                <option name="tag" value="flex">FLEX</option>
            </select>
        </div>
